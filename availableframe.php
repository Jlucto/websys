...
<!--*********************************************START OF NAVIGATION BAR****************************************--> 
        ...
        ?>
                    ...
                    <td  style="border: 1px dashed #8c8b8b;"><center><strong class="wow fadeInDown"><p style="margin-top:25px;">No.<?php echo $count;?></p></strong></center></td>
                        ...
                        <dt>Age:</dt> <dd><?php echo $row['prize'];?></dd>
                        </dl></td>
                        <td style="border: 1px dashed #8c8b8b;"><button class="btn btn-success  wow fadeInDown" name="order" type="button" style="margin-top:25px;" data-toggle="modal" data-target="#orderModal<?php echo $id;?>"> Adopt</button></td>
                    </tr>
                     <!-- Modal -->
  ...
  <div class="row">
    ...
    <div class="col-lg-10">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="savechanges"><i class="glyphicon glyphicon-thumbs-up"></i> Submit</button>
      </div>
      </form>
    </div>
  </div>
...
if(isset($_POST['savechanges'])){
    ...
    $result=mysqli_query($con, $sql);
			if(mysqli_num_rows($result)==5){
					echo '<script>alert("You reach maximum request of 5");
        ...
        $result=mysqli_query($con, $sql);
							if($result==true){
								echo '<script>alert("Your Request will be process.The system will follow up by contacting your number thankyou!");
