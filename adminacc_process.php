...
if (isset($_POST['update'])) {
    ...
    if (empty($nusername) || empty($npassword)) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            $sql = "UPDATE admininfo SET name='$name', contact='$phone', email='$mail', username='$nusername', password='$npassword' WHERE id='$id'";
            $result = mysqli_query($con, $sql);
    ...
    if (empty($nusername) || empty($npassword)) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            $sql = "INSERT INTO userinfo VALUES(NULL, '$name', '$address', '$phone', '$dob', '$nusername', '$npassword', '$type')";
            $result = mysqli_query($con, $sql);
